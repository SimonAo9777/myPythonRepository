...
class CrudRecord():  # Create a new record
    ...
    def display_records(self):
        ...
        db.RecordData.load_all_records(self)
    ...
    def delete_record(self):
        ...
        engine.execute("DROP DATABASE IF EXISTS vaccinationtypedbao")
        engine.execute("CREATE DATABASE vaccinationtypedbao")
        engine.execute("USE vaccinationtypedbao")
    ...
    def display_sortedlist(self):
        ...
        cdb.ChildRecordData.load_1000_records(self,list)
