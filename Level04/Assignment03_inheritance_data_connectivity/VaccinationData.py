...
class RecordData():
    ...
    def created_mySQL_connection(self):
        ...
        engine.execute("DROP DATABASE IF EXISTS vaccinationtypedbao")  # drop existed database
        engine.execute("CREATE DATABASE vaccinationtypedbao")  # create database
        engine.execute("USE vaccinationtypedbao")  # select new database
...
def readloop():
    for i in array_read:
        ...
        print("The above is Assignment 3 by Simon Ao")
